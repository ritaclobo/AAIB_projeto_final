...
def main():
    #Gravar os valores com o Raspberry PI
    import json
    import socket
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        host = "192.168.1.128" #put here the ip address of your mobile
        port = 4042
        
        filename=input("Output filename: ") #Para ficar de forma igual ao resto, teria que se escolher este nome "D1_1"
